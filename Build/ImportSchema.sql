...
delimiter ;;
create procedure jhgkfhbchdjnscfghdcbdjksjgcfhbdsjcgefwj ()
begin
...
ALTER TABLE `pages` ADD `tx_fed_page_flexform` text;
ALTER TABLE `pages` ADD `tx_fed_page_flexform_sub` text;
